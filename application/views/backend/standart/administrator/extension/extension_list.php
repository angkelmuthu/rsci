               ...
               <div class="box box-widget widget-user-2">
                  ...
                  <div class="widget-user-header ">
                     <div class="row pull-right">
                        <a class="btn btn-flat btn-success btn_add_new" id="btn_add_new" title="<?= cclang('add_new_button', 'Extension'); ?> (Ctrl+a)" href="<?=  site_url('administrator/extension/add'); ?>"><i class="fa fa-plus-square-o" ></i> <?= cclang('add_new_button', 'Extension'); ?></a>
                     </div>
                  ...
                  <form name="form_extension" id="form_extension" action="<?= base_url('administrator/extension/index'); ?>">
                     ...
                     <?php foreach($extensions as $extension):  ?>
                        ...
                        <tr>
                           ...
                           <td>
                            ...
                            <span class="text-muted" style="font-size: 12px">by : <?= _ent(isset($extension->item->author) ? $extension->item->author : '-' ); ?></span>
                           ...
                           <td width="200">
                              ...
                              <a href="<?= site_url('administrator/extension/deactivation/?ex='.$extension->getExtName()); ?>" class="label-default  "><i class="fa fa-minus-square  "></i> <?= cclang('btn_deactivation'); ?></a>
                              <?php }) ?>
                              <?php else: ?>
                              <?php is_allowed('extension_deactivate', function() use ($extension){?>
                              <a href="<?= site_url('administrator/extension/activation/?ex='.$extension->getExtName()); ?>" class="label-default"><i class="fa  fa-plus-square-o "></i> <?= cclang('btn_activation'); ?></a>
                              <?php }) ?>
                              <?php endif ?>
