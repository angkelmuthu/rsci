...
<section class="content-header">
    <h1>
        M Jasagroup        <small>Edit M Jasagroup</small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc">Edit M Jasagroup</h5>
                            <hr>
                        </div>
                        <?= form_open(base_url('administrator/m_jasagroup/edit_save/'.$this->uri->segment(4)), [
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: form_m_jasagroup.attr('action'),
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
        .done(function(res) {
          if(res.success) {
            var id = $('#m_jasagroup_image_galery').find('li').attr('qq-file-id');
            if (save_type == 'back') {
