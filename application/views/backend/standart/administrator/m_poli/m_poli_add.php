...
<section class="content-header">
    <h1>
        M Poli        <small><?= cclang('new', ['M Poli']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['M Poli']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            'name'    => 'form_m_poli', 
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" name="poli" id="poli" placeholder="Poli" value="<?= set_value('poli'); ?>">
                            ...
                            <div class="col-sm-8">
                                <select  class="form-control chosen chosen-select-deselect" name="kdunit" id="kdunit" data-placeholder="Select Kdunit" >
                                    ...
                                    <option value="<?= $row->kdunit ?>"><?= $row->unit; ?></option>
                                    <?php endforeach; ?>  
                                </select>
                                <small class="info help-block">
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/m_poli/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
