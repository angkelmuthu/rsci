...
<section class="content-header">
    <h1>
        T Diagnosa        <small><?= cclang('new', ['T Diagnosa']); ?> </small>
    </h1>
    <ol class="breadcrumb">
                ...
                <div class="box-body ">
                    ...
                    <div class="box box-widget widget-user-2">
                        ...
                        <div class="widget-user-header ">
                            ...
                            <h5 class="widget-user-desc"><?= cclang('new', ['T Diagnosa']); ?></h5>
                            <hr>
                        </div>
                        <?= form_open('', [
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" name="noreg" id="noreg" placeholder="Noreg" value="<?= set_value('noreg'); ?>">
                            ...
                            <div class="col-sm-8">
                                <textarea id="subjective" name="subjective" rows="5" class="textarea"><?= set_value('subjective'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="objective" name="objective" rows="5" class="textarea"><?= set_value('objective'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="asessment" name="asessment" rows="5" class="textarea"><?= set_value('asessment'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <textarea id="plan" name="plan" rows="5" class="textarea"><?= set_value('plan'); ?></textarea>
                                <small class="info help-block">
                                </small>
                            </div>
                        </div>
...
<script>
    $(document).ready(function(){
      ...
      $('.btn_save').click(function(){
        ...
        $.ajax({
          url: BASE_URL + '/administrator/t_diagnosa/add_save',
          type: 'POST',
          dataType: 'json',
          data: data_post,
        })
