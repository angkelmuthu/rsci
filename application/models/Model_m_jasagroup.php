...
class Model_m_jasagroup extends MY_Model {
	...
	public function count_all($q = null, $field = null)
	{
        ...
        if (empty($field)) {
	        foreach ($this->field_search as $field) {
	            if ($iterasi == 1) {
	                $where .= "m_jasagroup.".$field . " LIKE '%" . $q . "%' ";
	            } else {
	                $where .= "OR " . "m_jasagroup.".$field . " LIKE '%" . $q . "%' ";
	            }
	            $iterasi++;
	        }
	...
	public function get($q = null, $field = null, $limit = 0, $offset = 0, $select_field = [])
	{
        ...
        $this->db->order_by('m_jasagroup.'.$this->primary_key, "DESC");
		$query = $this->db->get($this->table_name);
...
/* End of file Model_m_jasagroup.php */
/* Location: ./application/models/Model_m_jasagroup.php */